...
import { getArtwork, updateArtwork, getArtists, Artist, Artwork } from "@gods.work/utils";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: 'Edit Artwork | Art Night Detroit',
  description: 'Edit an artwork profile for Art Night Detroit',
};

const EditArtworkPage = ({ artwork, artists }: { artwork: Artwork, artists: Artist[] }) => {
...
export async function getServerSideProps({ params }: { params: { artwork: string } }) {
