  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <VisionText>
          We&apos;re building a transparent, community-owned ticketing platform that
          ensures fair revenue distribution among artists, venues, and
          organizers. By leveraging blockchain technology, we&apos;re creating a
          system that eliminates middlemen, reduces fees, and puts more money
          directly into the hands of creators.
        </VisionText>
        ...
        <FeatureGrid>
          ...
          <FeatureCard>
            ...
            <FeatureDescription>
              Blockchain-based tickets prevent counterfeiting and scalping while
              providing a transparent record of all transactions and revenue
              distribution.
            </FeatureDescription>
          </FeatureCard>
          ...
          <FeatureCard>
            ...
            <FeatureDescription>
              ...
              vote, ensuring the system evolves to meet the needs of Detroit&apos;s
              creative ecosystem.
            </FeatureDescription>
          </FeatureCard>
        </FeatureGrid>
        ...
        <ProcessSteps>
          <ProcessStep>
            ...
            <StepContent>
              ...
              <StepDescription>
                Organizers create events and set revenue sharing agreements with
                artists and venues. All terms are encoded in smart contracts for
                transparency.
              </StepDescription>
            </StepContent>
          </ProcessStep>
          ...
          <ProcessStep>
            ...
            <StepContent>
              ...
              <StepDescription>
                ...
                according to the pre-set agreements, with minimal platform fees.
              </StepDescription>
            </StepContent>
          </ProcessStep>
          ...
          <ProcessStep>
            ...
            <StepContent>
              ...
              <StepDescription>
                Attendees present their digital tickets for verification at the
                event, with options for both online and offline validation.
              </StepDescription>
            </StepContent>
          </ProcessStep>
        </ProcessSteps>
      ...
      <Section>
        ...
        <TechDescription>
          ...
          combines the best of web3 technology with traditional web development
      ...
      <CallToAction>
        <CTAContent>
          ...
          <CTAText>
            We&apos;re looking for developers, designers, and event organizers to
            help shape this platform. Whether you&apos;re interested in smart
