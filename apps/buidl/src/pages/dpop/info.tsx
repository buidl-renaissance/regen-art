  ...
  return (
    <>
      ...
      <Container>
        ...
        {/* Hero */}
        <Hero>
          <HeroTitle>DPoP: Proof of Possession for a Decentralized Future</HeroTitle>
          ...
          <PrimaryButton href="#">Get Started with DPoP</PrimaryButton>
          <SecondaryButton href="#">Read the Whitepaper</SecondaryButton>
        </Hero>
