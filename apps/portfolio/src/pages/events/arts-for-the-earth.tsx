        ...
        <Section>
          ...
          <ExperiencesGrid>
            ...
            <ExperienceCard>
              ...
              <ExperienceContent>
                <ExperienceList>
                  <ExperienceItem>Live DJs & Musical Performances – A fusion of live music and DJ sets to uplift and inspire.</ExperienceItem>
                </ExperienceList>
              </ExperienceContent>
            </ExperienceCard>
            ...
            <ExperienceCard>
              ...
              <ExperienceContent>
                <ExperienceList>
                  <ExperienceItem>Local Vendors & Refreshments – A variety of delicious food and drinks available to nourish the community providing support for local small businesses.</ExperienceItem>
                </ExperienceList>
              </ExperienceContent>
            </ExperienceCard>
            ...
            <ExperienceCard>
              ...
              <ExperienceContent>
                <ExperienceList>
                  <ExperienceItem>Raffles – Exciting prizes and giveaways, with proceeds supporting environmental organizations.</ExperienceItem>
                  <ExperienceItem>Community Networking Board – A space to connect with local groups, opportunities, and like-minded individuals.</ExperienceItem>
                  <ExperienceItem>Vendor Marketplace – Featuring artists, jewelry makers, handcrafted clothing, and eco-conscious projects.</ExperienceItem>
                </ExperienceList>
              </ExperienceContent>
            </ExperienceCard>
          </ExperiencesGrid>
        ...
        <Section>
          ...
          <ExperiencesGrid>
            <ExperienceCard>
              ...
              <ExperienceContent>
                <ExperienceList>
                  <ExperienceItem>Temporary Tattoos – A fun way to showcase artwork on our skin without the needles or pain.</ExperienceItem>
                  <ExperienceItem>Community Coloring Book – Featuring artwork from participating artists, encouraging creativity and sharing insight relating to nature.</ExperienceItem>
                  <ExperienceItem>Sidewalk Chalk Art – Open space for kids to decorate the parking lot with colorful art.</ExperienceItem>
                </ExperienceList>
              </ExperienceContent>
            </ExperienceCard>
            ...
            <ExperienceCard>
              ...
              <ExperienceContent>
                <ExperienceList>
                  <ExperienceItem>Environmental Education – Interactive displays and information on how to keep the planet clean.</ExperienceItem>
                  <ExperienceItem>Arts & Scraps Craft Demo – Hands-on workshop by Arts & Scraps, promoting sustainable creativity.</ExperienceItem>
                  <ExperienceItem>Nature Scavenger Hunt – An engaging activity to help children connect with and learn about the natural world.</ExperienceItem>
                </ExperienceList>
              </ExperienceContent>
            </ExperienceCard>
          </ExperiencesGrid>
        ...
        <TicketSection>
          ...
          <TicketOptions>
            <TicketCard>
              ...
              <TicketPrice>$20 <span style={{ fontSize: '1rem' }}>(pre-sale)</span></TicketPrice>
              <TicketDescription>
                $25 at the door<br />
          ...
          <div style={{ marginTop: '2rem' }}>
            ...
            <TicketCard style={{ margin: '2rem auto', maxWidth: '600px' }}>
              <TicketDescription>
                ...
                $10 for one ticket<br />
                $15 for two tickets<br /><br />
                
                <strong>Raffle Prizes Include:</strong><br />
                • Tattoo flash art<br />
                • Artist prints & original artwork<br />
                • Donations from local businesses<br />
                • Other community-beneficial prizes
              </TicketDescription>
            </TicketCard>
          </div>
        </TicketSection>
        ...
        <Section>
          ...
          <div style={{ textAlign: 'center', marginTop: '2rem' }}>
            <p style={{ fontSize: '1.2rem', marginBottom: '2rem' }}>
              Join us in celebrating and protecting our planet through art, music, and community connection.
            </p>
