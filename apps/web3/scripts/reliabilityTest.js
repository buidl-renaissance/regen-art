...
async function main() {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    try {
      ...
      // Create tickets for the raffle (1-500 for reliability test)
      const tickets = Array.from({length: 500}, (_, j) => j + 1);
      console.log(`🎫 Creating raffle ${i + 1} with tickets 1-500...`);
      ...
      const raffleId = 16 + i; // Starting from raffle 16
